...
function random_number() {
    ran_x = Math.floor(Math.random()*10);
    ran_y = Math.floor(Math.random()*5);
}

function set_colors() {
    random_number();
    document.documentElement.style.setProperty('--main-bg-color', color_choices[ran_x][ran_y]);
}
